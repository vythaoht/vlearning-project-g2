                                ...
                                <div className={cls('col-6', styles.contentRight__padding)}>
                                    <ul>
                                        ...
                                        <li>
                                            <i className="fas fa-check" />
                                            <a href=''>
                                                Đăng ký công việc được trả lương cao hoặc làm freelancer trong một trong những lĩnh vực được yêu cầu nhiều nhất mà bạn có thể tìm thấy trong web dev ngay bây giờ</a>
                                        </li>
                                        <li>
                                            <i className="fas fa-check" />
                                            <a href=''>
                            ...
                            <div className={styles.courseDetails__item}>
                                <div className={styles.courseDetails__content}>
                                    <div className={styles.courseContent__header}>
                                        ...
                                        <button className={styles.courseContent__button}>Xem trước</button>
                                    </div>

                                    <p>Bài học</p>

                                    <div className={styles.courseContent__lesson}>
                                        <div className={cls('mt-1', styles.courseContent__lessonContent)}>
                                            <span>
                    ...
                    <div className={cls('row', styles.courserDetails__left)}>
                        <div className={styles.content__left}>
                            <div className={styles.content__leftBox}>
                                ...
                                <button className={styles.content__leftButton}>
                                    Đăng ký
                                </button>
