        ...
        <div className="row">
            ...
            <div className={cls("col-6", styles.right)}>
                <div className={styles.deskMate}>
                    <img className={styles.rela} src="./image/deskmate.png" alt="#" />
                    <img className={styles.abs1} src="./image/clouds.png" alt="#" />
                    <img className={styles.abs2} src="./image/clouds.png" alt="#" />
                    <img className={styles.abs3} src="./image/message.png" alt="#" />
                    <img className={styles.abs4} src="./image/code.png" alt="#" />
                </div>
            </div>
        </div>
    )
